...
const ProjectDetail = forwardRef( function ProjectDetail({pId, projectList,updateData},ref){
    ...
    const editButtonStyle=`text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 `
    ...
    return (
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400"><span className=' font-bold'>starts in:</span> {currentProject.startDue} <span className=' ml-11 font-bold'>ends in:</span> {currentProject.endDue}</p>
            </div>
           
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button class={editButtonStyle} onClick={()=>{handleEdit(currentProject)}}>Edit Project</button>
